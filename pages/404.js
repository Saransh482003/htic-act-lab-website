...
export default function Custom404() {
  ...
  return (
    <>
      <Head>
        <title>Page Not Found | Advanced Cardiovascular Technology Laboratory</title>
        <meta name="description" content="The requested page could not be found. Please navigate to another section of the ACT Lab website." />
      </Head>
